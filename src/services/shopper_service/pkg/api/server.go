...
import (
	...
	_ "github.com/BlackspaceInc/BlackspacePlatform/src/services/shopper_service/pkg/api/docs"
...
// @contact.url https://github.com/BlackspaceInc/BlackspacePlatform/src/services/shopper_service

// @license.name MIT License
// @license.url https://github.com/BlackspaceInc/BlackspacePlatform/src/services/shopper_service/blob/master/LICENSE
...
func NewServer(config *Config,
				...
				db *database.Db,
				authnClient *core_auth_sdk.Client) (*Server, error) {
	srv := &Server{
...
func (s *Server) registerMiddlewares() {
	...
	httpLogger := middleware.NewLoggingMiddleware()
	s.router.Use(httpLogger.LoggingMiddleware)
