...
authentication_handler_service is a tiny web application made with Go 
...
$ helm upgrade -i my-release authentication_handler_service/authentication_handler_service 
```

The command deploys authentication_handler_service on the Kubernetes cluster in the default namespace.
...
The following tables lists the configurable parameters of the authentication_handler_service chart and their default values.
...
`image.repository` | `github.com/blackspaceInc/BlackspacePlatform/authentication_handler_service` | Image repository
...
`service.grpcService` | `authentication_handler_service` | gPRC service name
...
```console
$ helm install my-release authentication_handler_service/authentication_handler_service \
...
```console
$ helm install my-release authentication_handler_service/authentication_handler_service -f values.yaml
```
