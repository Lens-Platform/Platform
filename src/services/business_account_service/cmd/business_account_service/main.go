...
import (
	...
	"github.com/BlackspaceInc/BlackspacePlatform/src/services/business_account_service/pkg/grpc"
	"github.com/BlackspaceInc/BlackspacePlatform/src/services/business_account_service/pkg/signals"
...
func main() {
	...
	fs.String("grpc-service-name", "business_account_service", "gPRC service name")
	...
	fs.String("ui-message", fmt.Sprintf("greetings from business_account_service v%v", version.VERSION), "UI message")
	...
	viper.SetDefault("ui-logo", "https://raw.githubusercontent.com/stefanprodan/business_account_service/gh-pages/cuddle_clap.gif")
	viper.Set("hostname", hostname)
	viper.Set("version", version.VERSION)
	viper.Set("revision", version.REVISION)
	viper.SetEnvPrefix("business_account_service")
...
func beginStressTest(cpus int, mem int, logger core_logging.ILog) {
	...
	if mem > 0 {
		path := "/tmp/business_account_service.data"
