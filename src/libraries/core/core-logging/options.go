...
import (
	...
	"github.com/BlackspaceInc/BlackspacePlatform/src/libraries/core/core-logging/sanitization"
)
...
// List of logs (k8s.io/klog + "github.com/BlackspaceInc/BlackspacePlatform/src/libraries/core/core-logging) flags supported by all logging formats
...
func unsupportedLoggingFlags() []string {
	...
	// blackspaceInc/blackspacePlatform/src/core/core-logging flags
	pfs := &pflag.FlagSet{}
	AddFlags(pfs)
